...
function createAdWindow() {
  ...
  adWindow = new BrowserWindow({
    width: 550,
    height: 300,
    x: screenSize.bounds.width - 550,
    y: screenSize.bounds.height - 345,
    frame: false,
    resizable: false,
    webPreferences: {
      nodeIntegration: true,
...
app.whenReady().then(() => {
  ...
  setInterval(() => {
    const NOTIFICATION_TITLE = "WELCOME TO VARILLA";
    const NOTIFICATION_BODY =
      "Click the Scan button to check for any problems with your computer";
